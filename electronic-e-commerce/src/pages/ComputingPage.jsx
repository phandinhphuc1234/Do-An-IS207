    ...
    return (
        <div className="bg-white min-h-screen w-full flex flex-col">
            ...
            <div className="flex-grow w-full px-4 md:px-10 py-8 flex flex-col md:flex-row gap-8 mt-14">
                ...
                {/* SIDEBAR FILTERS */}
                <aside className="w-full md:w-72 flex-shrink-0 space-y-8 bg-gray-50 p-6 rounded-2xl h-fit sticky top-24 shadow-sm border border-gray-100">
                    <h3 className="font-bold text-xl border-b pb-3 text-black flex items-center gap-2">
                        <span>💻</span> Bộ lọc Máy tính
                    </h3>
